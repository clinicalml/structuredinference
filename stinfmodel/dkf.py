...
import evaluate as external_evaluate
import learning as external_learning
...
class DKF(BaseModel, object):
    ...
    def infer(self, dataset):
        return external_evaluate.infer(self, dataset)
    
    
    def evaluateBound(self, dataset, mask, batch_size, actions=None, S=2, normalization = 'frame', additional={}):
        return external_evaluate.evaluateBound(self, dataset, mask, 
                batch_size, actions=None, S=2, 
                normalization = 'frame', additional=additional)
